...
const RegulationManagementPlatform: React.FC = () => {
  ...
  useEffect(() => {
    const fetchRegulations = async () => {
      try {
        ...
        const response = await fetch('http://ec2-18-134-10-75.eu-west-2.compute.amazonaws.com:9000/regulations');
  ...
  const handleAddRegulation = async () => {
    ...
    try {
      ...
      // POST to backend
      const res = await fetch("http://ec2-18-134-10-75.eu-west-2.compute.amazonaws.com:9000/regulations", {
        method: "POST",
        body: formData,
      });
  ...
  const handleUpdateRegulation = async (file: File | null | undefined) => {
    ...
    try {
      ...
      const res = await fetch(`http://ec2-18-134-10-75.eu-west-2.compute.amazonaws.com:9000/regulations/${regId}/versions`, {
        method: "POST",
        body: formData,
      });
  ...
  const handleChangeStatusUpdate = async (changeId: string, status: 'relevant' | 'not-relevant') => {
    ...
    try {
      ...
      const response = await fetch(
        `http://ec2-18-134-10-75.eu-west-2.compute.amazonaws.com:9000/regulations/${selectedReg._id}/versions/${currentVersionData.id}/changes/${changeId}`,
        {
          method: 'PUT',
          headers: {
